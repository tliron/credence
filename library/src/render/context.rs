...
/// Render context.
#[derive(Debug)]
pub struct RenderContext<'context> {
    /// Rendered page.
    pub rendered_page: &'context RenderedPage,
    ...
    /// Templates.
    pub templates: &'context Templates,

    /// Configuration.
    pub configuration: &'context CredenceConfiguration,
}

impl<'context> RenderContext<'context> {
    /// Constructor.
    pub fn new(
        rendered_page: &'context RenderedPage,
