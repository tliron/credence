...
/// Catalog annotation.
pub struct CatalogAnnotation<'this> {
    /// Sort column.
    pub sort_column: Option<RefTraversal<'this, WithAnnotations>>,

    /// Sort ascending.
    pub sort_ascending: bool,

    /// Extra columns.
    pub extra_columns: ExtraColumns<'this>,
}

impl<'this> CatalogAnnotation<'this> {
    /// Constructor.
    pub fn new(
        sort_column: Option<RefTraversal<'this, WithAnnotations>>,
        sort_ascending: bool,
        extra_columns: ExtraColumns<'this>,
    ) -> Self {
        Self { sort_column, sort_ascending, extra_columns }
    }

    /// Resolve.
    pub fn resolve(variant: &'this Variant<WithAnnotations>) -> Self {
